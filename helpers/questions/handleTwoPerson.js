...
function twoTwo() {
    ...
    return inquirer.prompt([{
        name: "two",
        type: "list",
        message: "You notice another tick on your arm. What kind of disease can you contract from ticks?",
...
function twoFive() {
    ...
    return inquirer.prompt([{
        name: "five",
        type: "list",
        message: "The poison oak rash is getting worse. How should you treat your poison oak rash?",
...
function twoSix() {
    ...
    return inquirer.prompt([{
        name: "six",
        type: "list",
        message: "You are worried about the tick bite you got. How long does it take for a tick to transmit Lyme disease?",
...
function twoNine() {
    ...
    return inquirer.prompt([{
        name: "nine",
        type: "list",
        message: "You notice you keep getting bit by mosquitos. What can you use for mosquito repellant?",
